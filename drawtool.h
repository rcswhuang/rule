...
public:
  ...
  //  bool isHaveConnect(HGraphicsView* pView,quint16 wIn,quint16 wOut,quint8 btOutInIndex);//是否连接
  //  void addNewConnect(HGraphicsView* pView, HDrawObj* pObj,HDrawObj* pSelectObj,quint8 btIndex);//新的连接
